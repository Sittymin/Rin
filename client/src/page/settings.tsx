...
export function Settings() {
    ...
    const [clientConfig, setClientConfig] = useState<ConfigWrapper>(
        defaultClientConfigWrapper,
    );
    const [serverConfig, setServerConfig] = useState<ConfigWrapper>(
        defaultServerConfigWrapper,
    );
    ...
    useEffect(() => {
        ...
        client
            ...
            .catch((err: any) => {
                showAlert(
                    t("settings.get_config_failed$message", {
                        message: err.message,
                    }),
                );
            })
        ...
        if (file) {
            await client.wp
                ...
                .then(({ data }) => {
                    if (data && typeof data !== "string") {
                        setMsg(
                            t("settings.import_success$success$skipped", {
                ...
                .catch((err) => {
                    showAlert(
                        t("settings.import_failed$message", {
                            message: err.message,
                        }),
                    );
                });
        ...
        <div className="flex flex-col justify-center items-center">
            <ServerConfigContext.Provider value={serverConfig}>
                <ClientConfigContext.Provider value={clientConfig}>
                    <main
                        className="wauto rounded-2xl bg-w m-2 p-6"
                    ...
                    >
                        ...
                        <div className="flex flex-col items-start space-y-2">
                            ...
                            <ItemInput
                                ...
                                description={t(
                                    "settings.friend.health.ua.desc",
                                )}
                                type="server"
                                configKey="friend_ua"
                        ...
                        */}
                            ...
                            <ItemButton
                                    ...
                                    await client.config.cache
                                        ...
                                        .then(({ error }: { error: any }) => {
                                            if (error) {
                                                showAlert(
                                                    t(
                                                        "settings.cache.clear_failed$message",
                                                        {
                                                            message:
                                                                error.message,
                                                        },
                                ...
                                alertTitle={t(
                                    "settings.cache.clear.confirm.title",
                                )}
                                alertDescription={t(
                                    "settings.cache.clear.confirm.desc",
                                )}
                            />
                            <ItemWithUpload
                    ...
                    <div className="flex flex-col items-start w-full">
                        ...
                        <ul className="flex flex-col items-start max-h-64 overflow-auto w-full">
                            {msgList.map((msg, idx) => (
                                ...
                                >
                                    {t(
                                        "settings.import_skipped_item$title$reason",
                                        {
                                            title: msg.title,
                                            reason: msg.reason,
                                        },
...
function ItemSwitch({
    ...
    function updateConfig(type: "client" | "server", key: string, value: any) {
        ...
        client
            ...
            .catch((err) => {
                showAlert(
                    t("settings.update_failed$message", {
                        message: err.message,
                    }),
                );
                setChecked(checkedValue);
